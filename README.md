...
>
> ——1992 年《軟體世界》雜誌專文〈宇宙傳奇 IV 時空穿越者〉
...
> **[《宇宙傳奇》系列繁體中文譯名對照表](docs/glossary/README.md)** — 橫跨二代、三代、四代的
> 專有名詞總表，分人物／星球地點／組織企業／道具科技／品牌梗／創作者六類，列出各詞在哪幾代
> 出現過、為何這樣定，以及還沒對齊的項目。系列後續作品的中文化以那份為依據。
>
> 本作翻譯期間逐字照用的作業清單另在 [`translation/GLOSSARY.md`](translation/GLOSSARY.md)。
...
- 1992 年《軟體世界》雜誌：代理版全頁廣告文案，與專文〈宇宙傳奇 IV 時空穿越者〉。
